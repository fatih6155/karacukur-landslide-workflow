...
digraph G {
  ...
  B2 [label=<
    ...
    <font point-size='30'>
    <br/>
    ??? Thermal fatigue: Cumulative F-T cycles<br align='left'/>
  ...
  B4 [label=<
    ...
    ??? Outcome: Kara&#231;ukur Landslide (April 22)<br align='left'/>
    </font>
  >, fillcolor='#FFCCCC'];
